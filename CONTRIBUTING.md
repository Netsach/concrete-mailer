...
-  If not, submit an [issue ticket](<issues_link>) that respects the following steps:
...
-  Make sure your tests, pylint and [bandit](https://bandit.readthedocs.io/en/latest/) pass (see chapter [Code Quality]() below for more details on how to run the checks)
